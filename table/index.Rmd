...
df <- cases %>% 
  ...
  select(area_name, new_cases, previous_week, current_week, change, previous_week_rate, 
         current_week_rate, percent_rate)
...
tbl <- reactable(df, 
                 ...
                 columns = list(
                   ...
                   previous_week = colDef(header = with_tooltip("Previous week", paste("week ending", format(max(cases$date)-days(12),'%A %d %B'))),
                                          align = "left"),
                   current_week = colDef(header = with_tooltip("Current week", paste("week ending", format(max(cases$date)-days(5),'%A %d %B'))),
                                      align = "left"),
                   ...
                   previous_week_rate = colDef(header = with_tooltip("Previous week", paste("week ending", format(max(cases$date)-days(12),'%A %d %B'))),
                                               align = "left"),
                   current_week_rate = colDef(header = with_tooltip("Current week", paste("week ending", format(max(cases$date)-days(5),'%A %d %B'))),
                                           align = "left"),
                 ...
                 columnGroups = list(
                   ...
                   colGroup(header = "Per 100,000", columns = c("previous_week_rate", "current_week_rate", "percent_rate"))
                   )
                 )
```
